...
var spotter = Promise.method(function (data, property, options) {
  return new Promise(function (resolve, reject) {
    ...
    var opts = _.defaults(opts, { pace: false }, { maxRedirects: 3 }, { followRedirect: true });
    var parsedObjects = [];
    ...
    Promise.all(data.map(function(object) {
      current = current.then(function() {
        return rp.head({ uri: object[property], resolveWithFullResponse: true, maxRedirects: opts.maxRedirects })
